...
namespace Db.POCOIterator
{
    public class DbIterator : IPOCOIterator
    {
        ...
        {
            if(IsShowingDataMemberAttributes)
            {
                pocoWriter.Write("[");
                pocoWriter.WriteKeyword("Table");
                pocoWriter.Write("(\"");
                pocoWriter.Write(string.Format("{0}.{1}", dbObject.Schema, dbObject.Name));
                pocoWriter.Write("\")");
                pocoWriter.Write("]");
                pocoWriter.WriteLine();
                pocoWriter.Write("[");
                pocoWriter.WriteKeyword("DataContract");
                pocoWriter.Write("]");
                pocoWriter.WriteLine();
            }
        }
        ...
        protected virtual void WriteColumnAttributes(IColumn column, string cleanColumnName, IDbObjectTraverse dbObject, string namespaceOffset)
        {
            if (IsShowingDataMemberAttributes)
            {
                pocoWriter.Write(Tab);
                pocoWriter.Write("[");
                pocoWriter.WriteKeyword("DataMember");
        ...
        public virtual bool IsShowingDataMemberAttributes { get; set; }
