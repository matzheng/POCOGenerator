...
namespace POCOGenerator
{
    public partial class POCOGeneratorForm : Form
    {
        ...
        private void POCOGeneratorForm_Load(object sender, EventArgs e)
        {
            ...
            IsShowingDataMemberAttributes = chkDataMember.Checked;
            LoadOptions();
        }
        ...
        public bool IsShowingDataMemberAttributes { get; set; }
        ...
        private IPOCOIterator GetPOCOIterator(IEnumerable<IDbObjectTraverse> dbObjects, StringBuilder sb)
        {
            ...
            iterator.IsShowingDataMemberAttributes = IsShowingDataMemberAttributes;
        ...
        private void chkDataMember_CheckedChanged(object sender, EventArgs e)
        {
            IsShowingDataMemberAttributes = chkDataMember.Checked;
            WritePocoToEditor();
        }
